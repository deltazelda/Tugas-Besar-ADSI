	...
	<?php
						...
						if($bag==1)
						{
							...
							<tr>
								<td>Tanggal Lahir</td>
								<td>:</td>
								<td><input type="text" id="tanggal" name="tanggalLahir" maxlength="100" value="<?php echo $data['Tanggal_Lahir']; ?>"/></td>
							</tr>
							<tr><td>&nbsp;</td></tr>
							<tr>
						...
						if($bag==2)
						{
							...
							<tr>
								<td>Jenis Kelamin</td>
								<td>:</td>
								<td><input type="text" name="jk" maxlength="5" required="required"  value="<?php echo $data['Jenis_Kelamin']; ?>" disabled="disabled"/></td>
							</tr>
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td>Pendidikan</td>
							...
							<tr>
								<td>Profesi</td>
								<td>:</td>
								<td><input type="text" name="prof" required="required"  value="<?php echo $data['Profesi']; ?>" /></td>
							</tr>
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td>Kecamatan</td>
