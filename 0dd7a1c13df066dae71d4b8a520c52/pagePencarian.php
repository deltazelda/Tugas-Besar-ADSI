...
<div class="main-container">
  <div class="container1">
	...
	if($halaman == 1)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_atlet where Kecamatan='$kecamatan' and Nama like '%$key%' or Cabang_Olahraga like '%$key%' or Kecamatan like '%$key%'";
	}else
	if($halaman == 2)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_sdm where Kecamatan='$kecamatan' and Profesi='WASIT' and  Nama like '%$key%' or Klasifikasi like '%$key%' or Kecamatan like '%$key%' or Cabang_Olahraga like '%$key%'";
	}else
	if($halaman == 3)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_sdm where Kecamatan='$kecamatan' and Profesi='PELATIH' and  Nama like '%$key%' or Klasifikasi like '%$key%' or Kecamatan like '%$key%' or Cabang_Olahraga like '%$key%'";
	}else
	if($halaman == 4)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_gor where Kecamatan='$kecamatan' and nama_gedung like '%$key%' or cb_olahraga like '%$key%' or Kecamatan like '%$key%'";
	}else
	if($halaman == 5)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_sor where Kecamatan='$kecamatan' and club like '%$key%' or cb_olahraga like '%$key%' or Kecamatan like '%$key%'";
	}else
	if($halaman == 6)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_prestasi_atlet where t_atlet.Id_atlet=t_prestasi_atlet.id_atlet and t_atlet.Kecamatan='$kecamatan' and t_prestasi_atlet.Nama like '%$key%' or t_prestasi_atlet.Tahun like '%$key%' or t_prestasi_atlet.Prestasi like '%$key%' or t_prestasi_atlet.Tingkat like '%$key%'";
	}else
	if($halaman == 7)
	{
		$query = "SELECT COUNT(*) AS jumData FROM t_prestasi_club where t_sor.id_sor=t_prestasi_club.id_club and t_sor.Kecamatan='$kecamatan' and t_prestasi_club.Nama like '%$key%' or t_prestasi_club.Tahun like '%$key%' or t_prestasi_club.Prestasi like '%$key%' or t_prestasi_club.Tingkat like '%$key%'";
	}
	...
	if(($jumData != 0) and ($key !=''))
	{
		...
		if($halaman == 1)
		{
			$query = "SELECT * FROM t_atlet where Kecamatan='$kecamatan' and Nama like '%$key%' or Cabang_Olahraga like '%$key%' or Kecamatan like '%$key%' LIMIT $offset, $dataPerPage";
		}else
		if($halaman == 2)
		{
			$query = "SELECT * FROM t_sdm where Kecamatan='$kecamatan' and Profesi='WASIT' and Nama like '%$key%' or Klasifikasi like '%$key%' or Kecamatan like '%$key%' or Cabang_Olahraga like '%$key%' LIMIT $offset, $dataPerPage";
		}else
		if($halaman == 3)
		{
			$query = "SELECT * FROM t_sdm where Kecamatan='$kecamatan' and Profesi='PELATIH' and Nama like '%$key%' or Klasifikasi like '%$key%' or Kecamatan like '%$key%' or Cabang_Olahraga like '%$key%' LIMIT $offset, $dataPerPage";
		}else
		if($halaman == 4)
		{
			$query = "SELECT * FROM t_gor where Kecamatan='$kecamatan' and nama_gedung like '%$key%' or cb_olahraga like '%$key%' or Kecamatan like '%$key%' LIMIT $offset, $dataPerPage";
		}else
		if($halaman == 5)
		{
			$query = "SELECT * FROM t_sor where Kecamatan='$kecamatan' and club like '%$key%' or cb_olahraga like '%$key%' or Kecamatan like '%$key%' LIMIT $offset, $dataPerPage";
		}else
		if($halaman == 6)
		{
