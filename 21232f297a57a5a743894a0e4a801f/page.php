  ...
  <div class="container1">
    ...
    <article class="box" id="home_featured21">
       <?php
						...
						if($halaman == 1)
						{
							$query = "SELECT * FROM t_atlet LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 2)
						{
							$query = "SELECT * FROM t_sdm where Profesi='WASIT' LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 3)
						{
							$query = "SELECT * FROM t_sdm where Profesi='PELATIH' LIMIT  $offset, $dataPerPage";
						}else
						if($halaman == 4)
						{
							$query = "SELECT * FROM t_gor LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 5)
						{
							$query = "SELECT * FROM t_sor LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 6)
						{
							$query = "SELECT * FROM t_prestasi_atlet LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 7)
						{
							$query = "SELECT * FROM t_prestasi_club LIMIT $offset, $dataPerPage";
						}else
						if($halaman == 8)
						{
							$query = "SELECT * FROM petugas LIMIT $offset, $dataPerPage";
						}
						...
						if ($noPage < $jumPage) 
							echo "<a href='".$_SERVER['PHP_SELF']."?page=".($noPage+1)."&halaman=".$halaman."'><font color='#FFFFFF'>Next &gt;&gt;</font></a>";
